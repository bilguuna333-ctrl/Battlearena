...
// K=40 means equal-ELO match awards exactly ±20 to winner/loser.
// Standard ELO scaling then naturally rewards upsets and reduces gain
// when a heavy favourite wins.
const K_FACTOR = 40;
